...
<html>
	...
	<body style="background-color: #F9F9F9 !important;">
		<div class="container mt-5 h-100 bg-light">
			...
			<form action="formHandlers/loginHandler.php" method="POST" class="w-50 mx-auto mt-5 border p-3 shadow-sm rounded-4">
				...
				<div class="button-group d-grid gap-2">
					<button type="submit" name="login" class="btn" style="background-color: #988F88;">Login</button>
